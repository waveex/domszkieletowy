      ...
      <div id="#oferta" className="bg-white ">
        <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:py-24 lg:px-8">
          <div className="max-w-3xl  grid-1-3">
            ...
            <p className="mt-3 text-3xl text-gray-500 sm:mt-5 sm:text-xl lg:text-3xl xl:text-xl">
              Realizujemy projekty budowy domów szkieletowych i różnych
          ...
          <div className=" grid-1">
            <p className="mt-4 text-3xl text-gray-500 text-center">
              ...
              zagranicy. Prace wykonujemy w obrębie 100 kilometrów od Warszawy.
            </p>
          </div>
